...
export class user {
    ...
    constructor(name: string, age: number, gender: string, city: string, motherLanguage: string, englishLevel: string, school: string, other: string) {
        this.age = age;
        this.gender = gender;
        this.city = city;
    ...
    self_introduction(): string {
        return "My name is "+this.name +". I am "+ this.age +" years old and I live in "+ this.city +". My mother tongue is "+
            this.motherLanguage +" and my English proficiency level is "+ this.englishLevel +". I attend "+ this.school +". "+ this.other +"."+
    ...
    static current_user =new user("Max LI", 10, "male", "Hong Kong", "Chinese", "A2", "Po On Commercial Association Wan Ho Kan Primary School","I like origami and comics.");

    static self_introduction(){
